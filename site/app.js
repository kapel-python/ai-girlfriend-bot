  ...
  var PERSONAS = [
    {
      ...
      title: 'Реалистичная',
      desc: 'Живая и естественная: у неё есть свои планы, настроение и желания. Именно такой характер можно увидеть в примере выше.',
      meters: [78, 45, 60],
      chat: [
    ...
    },
    {
      ...
      title: 'Манипулятор',
      desc: 'Сложный характер с обидами и проверками. Перед выбором бот покажет предупреждение, что такой стиль может быть эмоционально тяжёлым.',
      meters: [55, 80, 90],
      chat: [
        { side: 'out', text: 'как день прошёл?' },
    ...
    },
    {
      id: '18plus', tab: '🔞 18+',
      title: '18+',
      desc: 'Только для совершеннолетних. Бот смело флиртует, но всегда уважает отказ и личные границы.',
      meters: [90, 85, 70],
      chat: [
    ...
    },
    {
      ...
      title: 'Свой характер',
      desc: 'Можно задать имя, биографию, привычки и манеру речи. Бот сохранит ваш характер, а основные правила останутся прежними.',
      meters: [60, 60, 60],
      chat: [
        { side: 'out', text: 'открой настройки характера и выбери свой вариант' },
        { side: 'in',  text: 'её можно назвать как захочешь' },
        { side: 'in',  text: 'у неё будут твои привычки и биография' },
        { side: 'in',  text: 'а основные правила останутся прежними' }
      ]
    }
  ];
